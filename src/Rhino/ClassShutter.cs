...
namespace Rhino
{
	...
	/// through the LiveConnect, should implement this interface.
	/// </remarks>
	/// <seealso cref="Context.SetClassShutter(ClassShutter)">Context.SetClassShutter(ClassShutter)</seealso>
	...
	public interface ClassShutter
	{
		...
		/// </param>
		/// <returns>whether or not to reveal this class to scripts</returns>
		bool VisibleToScripts(string fullClassName);
	}
}
