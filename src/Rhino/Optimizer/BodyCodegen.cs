	...
	internal class BodyCodegen
	{
		internal MethodBuilder GenerateBodyCode()
		{
			...
			MethodBuilder method = isGenerator
				...
				? tb.DefineMethod(codegen.GetBodyMethodName(scriptOrFn) + "_gen", MethodAttributes.Private | MethodAttributes.Static, typeof (object), new[] { tb, typeof (Context), typeof (Scriptable), typeof (object), typeof (object), typeof (int) })
